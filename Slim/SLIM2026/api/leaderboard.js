...
const FILE_PATH = '/Slim/2026/SLIM 2026.xlsm'; // adjust if needed
...
export default async function handler(req, res) {
    try {
        ...
        // 2️⃣ Get named range values
        const encodedPath = encodeURIComponent(FILE_PATH);
        const rangeUrl = `https://graph.microsoft.com/v1.0/me/drive/root:/${encodedPath}:/workbook/names('${NAMED_RANGE}')/range`;
